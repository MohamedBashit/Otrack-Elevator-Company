                    ...
                    if (checkEmpty($email) && checkEmpty($password)) 
                    {
                        ...
                        if (validEmail($email)) 
                        {
                            ...
                            if ($check) 
                            {
                                ...
                                {
                                    $error_message = "المعلومات غير صحيحة";
                                }
                            }
                            else 
                            {
                                $error_message = "بريد الكتروني خاطئ";
                            }
                        }
                        else 
                        {
                            $error_message = "اكتب البريد الألكتروني بشكل صحيح";
                        }
                    }
                    else 
                    {
                        $error_message = "برجاء ملء الحقول";
                    }
        ...
        ?>
            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" class="border p-5" >
                <div class="row">
                    ...
                    <div class="col-sm-12  ">
                        <h3 class="text-center p-3 text-white">تسجيل الدخول</h3>
                    </div>
